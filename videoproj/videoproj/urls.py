...
from django.urls import path
from videoproj.videoapp.views import video_list, video_detail, add_video, add_comment, register_user, add_favorite_video, remove_favorite_video, favorite_videos
